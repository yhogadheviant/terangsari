      ...
      <div className="mx-auto flex max-w-6xl items-center justify-between gap-2 px-2.5 py-2 sm:gap-3 sm:px-4 sm:py-2.5">
        <div className="flex min-w-0 items-center gap-1.5 overflow-x-auto scrollbar-hide sm:gap-2">
          <button
            type="button"
            onClick={() => router.push("/")}
            className={`flex shrink-0 items-center gap-2 rounded-xl px-2.5 py-2 text-xs font-bold sm:px-3 sm:text-sm transition ${
              pathname === "/"
        ...
        <button
          type="button"
          onClick={logout}
          className="flex shrink-0 items-center gap-2 rounded-xl border border-red-100 bg-red-50 px-2.5 py-2 text-xs font-bold sm:px-3 sm:text-sm text-red-600 transition hover:border-red-200 hover:bg-red-100 hover:shadow-sm active:scale-[0.98]"
        >
