  ...
  return (
    <div className="min-h-screen bg-slate-50">
      <header className="relative overflow-hidden bg-gradient-to-br from-blue-700 via-blue-700 to-blue-900 text-white">
        <div className="relative mx-auto max-w-6xl px-3 py-5 sm:px-4 sm:py-9">
          <div className="flex items-start justify-between gap-2 sm:items-center sm:gap-4">
            ...
            <button
              ...
              className="flex shrink-0 items-center gap-2 rounded-xl bg-white px-3 py-2 text-xs font-bold sm:px-4 sm:py-2.5 sm:text-sm text-blue-700 shadow-lg shadow-blue-950/10 transition hover:-translate-y-0.5 hover:bg-blue-50 active:scale-95"
            >
          ...
          <div className="mt-6 sm:mt-8">
            ...
            <div className="mt-1 flex items-center gap-2 text-lg font-bold sm:text-xl">
              <span>
      ...
      <main className="mx-auto max-w-6xl px-3 py-4 pb-16 sm:px-4 sm:py-6 sm:pb-20">
        <section className="mb-5 rounded-2xl border border-slate-200 bg-white p-4 sm:mb-6 sm:p-5 shadow-sm">
            ...
            {menu.map((item) => {
              ...
              return (
                <button
                 ...
                 className="group relative block overflow-hidden rounded-2xl border border-slate-200/80 bg-white p-3.5 text-left sm:p-4 shadow-sm transition-all duration-200 hover:-translate-y-1 hover:border-blue-300 hover:shadow-lg active:scale-[0.98]"
                >
